...
const imageUploadHandler: UploadHandler = (blobInfo, success, failure, progress) => {
  ...
  xhr.onload = () => {
    ...
    if (!json || typeof json.url !== 'string') {
      failure(`Response missing url: ${xhr.responseText}`);
      return;
    }
...
const result = ({
  ...
  useEffect(() => {
    async function loadTinyMCE() {
      ...
      global.tinymce.addI18n('zh_CN', zhCN);
      await Promise.all([
